...
# 预测数据
random_select('predict_real.csv', predict_count, 'predict_real_fig.csv')


# 测试数据
random_select('test_real.csv', test_count, 'test_real_fig.csv')


# 训练数据
random_select('train_real.csv', train_count, 'train_real_fig.csv', 'train')
