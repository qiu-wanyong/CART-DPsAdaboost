...
for tree_depth in tree_depth_list:
    ...
    cart_model = CartAdaBoostAdult(tree_depth, 30, 0.2, 'f')
...
for e in epsilon:
    ...
    for tree_depth in tree_depth_list:
        DPsAdaBoost_model = CartAdaBoostAdult(tree_depth, 2, e, 'e')
